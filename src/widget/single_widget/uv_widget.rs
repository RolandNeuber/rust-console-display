...
#[deprecated]
pub struct UvWidgetOld<T: DynamicConsoleDisplay<S>, S: Pixel> {
...
impl<T: DynamicConsoleDisplay<S>, S: Pixel> UvWidgetOld<T, S> {
...
impl<S: Pixel, T: DynamicConsoleDisplay<S>> UvWidgetOld<T, S> {
...
impl<
    T: DynamicCharacterWidth
        + DynamicCharacterHeight
        + StaticCharacterWidth
        + DynamicWidth
        + DynamicHeight,
    S: Pixel,
> StaticCharacterWidth for UvWidget<T, S>
{
...
impl<
    T: DynamicCharacterWidth
        ...
        + DynamicHeight,
    S: Pixel,
> StaticCharacterHeight for UvWidget<T, S>
{
...
impl<
    T: DynamicCharacterWidth
        ...
        + DynamicHeight,
    S: Pixel,
> DynamicHeight for UvWidget<T, S>
{
...
impl<
    T: DynamicCharacterWidth
        ...
        + DynamicHeight,
    S: Pixel,
> DynamicCharacterWidth for UvWidget<T, S>
{
...
impl<
    T: DynamicCharacterWidth
        ...
        + DynamicHeight,
    S: Pixel,
> DynamicCharacterHeight for UvWidget<T, S>
{
...
impl<
    T: DynamicCharacterWidth
        ...
        + DynamicHeight,
    S: Pixel,
> ToStringData for UvWidget<T, S>
{
    fn string_data(&self) -> crate::widget::StringData {
...
> SetPixel<S> for UvWidget<T, S>
{
    ...
    fn draw<D: Drawable<N> + Transformable, const N: usize>(
        &mut self,
        drawable: &D,
        value: <S as Pixel>::U,
    ) where
...
impl<
    T: DynamicWidth
        ...
        + DynamicCharacterHeight,
    S: Pixel,
> const SingleWidget<T> for UvWidget<T, S>
{
    type Borrowed<'a>
        = &'a T
    where
...
impl<
    T: DynamicWidth
        ...
        + DynamicCharacterHeight,
    S: Pixel,
> const DerefMut for UvWidget<T, S>
{
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.child
    }
