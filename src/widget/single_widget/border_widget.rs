...
#[deprecated]
pub struct BorderWidgetOld<T: DynamicWidget, S: Border> {
    child: T,
    border: S,
}

impl<T: DynamicWidget, S: Border> BorderWidgetOld<T, S> {
    impl_new!(pub const BorderWidgetOld<T, S>, child: T, border: S);
}

impl<T: DynamicWidget, S: Border> DynamicWidget for BorderWidgetOld<T, S> {
...
impl<T: DynamicWidget, S: Border> const Deref for BorderWidgetOld<T, S> {
    type Target = T;
...
impl<T: DynamicWidget, S: Border> const DerefMut
    for BorderWidgetOld<T, S>
{
